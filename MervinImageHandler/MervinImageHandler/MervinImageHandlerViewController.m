//
//  MervinImageHandlerViewController.m
//  MervinImageHandler
//
...
@interface MervinImageHandlerViewController () <UIGestureRecognizerDelegate>
...
@implementation MervinImageHandlerViewController
...
- (void)addBlurryButtonPressed:(UIButton *)sender
{
    ...
    UIImageView * newImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"smile"]];
    newImageView.userInteractionEnabled = YES;
